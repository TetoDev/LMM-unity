...
public class SaveAndLoad : MonoBehaviour
{
    ...
    private void LoadStructures(string biomeName, TBiome biome){
        List<string> text = GetFileContent(filePathStructuresData);
        ...
        for(int i = 1 ; i < text.Count; i++){
            ...
            lineOfWord = line.Split(',');
            tempStructure.nameScene = lineOfWord[0];
            tempStructure.idTile = int.Parse(lineOfWord[1]);
            tempStructure.spawnCord = int.Parse(lineOfWord[2]);
